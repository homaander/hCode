...
Так-же любую ленту можно разложить через насколько (1) лент

Таблица разложение ленты на 2 конкретные: [Таблица разложений](Disperce/DisperceTable.md)
...
Две нечетные ленты (за исключением (5)) образуют любую ленту кроме (0) и (5), имключения: (9,1) (7,3) (5,5) -> 0 и (5,5) -> (5)
Данные для получения четных из двух нечетных: [Нечетные в четное](Disperce/TwoOddToEven.md)
